 ...
 *\return
 */
void MissionServer::executeCB(const nautonomous_mission_msgs::MissionPlanGoalConstPtr &goal) 
{
	// helper variables
	nautonomous_mission_msgs::MissionPlanFeedback feedback_;
    	nautonomous_mission_msgs::MissionPlanResult result_;
	...
	MoveBaseClient moveBase = MoveBaseClient();
	...
	{
		nautonomous_mission_msgs::OperationPlan current_operation = *operation_iterator;
		...
		if(current_operation.automaticPlanning)
		{
			...
			ros::ServiceClient pathfinder_client = nh.serviceClient<nautonomous_routing_msgs::PathfinderVaarkaart>("find_path_amsterdam_canals");
			
			nautonomous_routing_msgs::PathfinderVaarkaart pathfinder_srv;
		...
		//Cropper
		ros::ServiceClient map_cropper_client = nh.serviceClient<nautonomous_map_msgs::CropMapPoints>("crop_map_points");
		...
		//Map Server
		ros::ServiceClient map_server_client = nh.serviceClient<nautonomous_map_msgs::MapLoader>("map_server/load_map");
